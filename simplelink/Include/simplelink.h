...
/*!
 ...
 Listed below are the various modules in the SimpleLink CC31XX driver:
     ...
     -# \ref nvmem  - provides file system capabilities to TI's CC31XX that can be used by both the CC31XX device and the user.
...
extern void sl_GeneralEvtHdlr(void *pArgs);
#endif

#if (defined(sl_WlanEvtHdlr))
extern void sl_WlanEvtHdlr(void *pArgs);
#endif

#if (defined(sl_NetAppEvtHdlr))
extern void sl_NetAppEvtHdlr(void *pArgs);
#endif

#if (defined(sl_SockEvtHdlr))
extern void sl_SockEvtHdlr(void *pArgs);
#endif

#if (defined(sl_HttpServerCallback))
extern void sl_HttpServerCallback(void *pEvent, void *pResponse);
#endif

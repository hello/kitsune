...
typedef enum
{
    SL_WLAN_CONNECTED = 0x1,
    SL_WLAN_ROLE_STA  = 0x2
}SlWlanConnectInfoFlags_e;

typedef struct
{
    _u16 ConnectionFlags;   /* see SlWlanConnectInfoFlags_e */
    _u8  ConectionProtocol; /* SL_WLAN_CONNECTION_PROTOCOL_P2PCL/SL_WLAN_CONNECTION_PROTOCOL_STA */
    _u8  Reserved;
	SlWlanConnectionInfo_u ConnectionInfo;
}SlWlanConnectionInfo_t;
...
/*!
    ...
    \param[in]  InactivityTimeoutSec -      The period of time (in seconds) the system waits before it automatically
                                            ...
                                            set to 0 in order to stop provisioning
...
/*!
    ...
    \code
		_i16 RetVal = 0 ;
		_u16 Len = sizeof(SlWlanConnectionInfo_t) ;
		SlWlanConnectionInfo_t WlanConnectInfo ;

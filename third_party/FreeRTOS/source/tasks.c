		...
		*pcWriteBuffer = 0x00;
		...
		if( pxTaskStatusArray != NULL )
		{
			...
			for( x = 0; x < uxArraySize; x++ )
			{
				...
				sprintf( pcWriteBuffer, "\t%c\t%u\t%u\t%u\r\n", cStatus, ( unsigned int ) pxTaskStatusArray[ x ].uxCurrentPriority, ( unsigned int ) pxTaskStatusArray[ x ].usStackHighWaterMark*4, ( unsigned int ) pxTaskStatusArray[ x ].xTaskNumber );

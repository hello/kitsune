...
int Cmd_get_octogram(int argc, char * argv[]) {
	...
	uint32_t SNDR_Nu = 0;
	uint32_t SNDR_De = 0;
	SNDR_Nu = 10000*8*octorgram_result.logenergy[2];
	SNDR_De = (14*octorgram_result.logenergy[3]+10*octorgram_result.logenergy[4] +10*octorgram_result.logenergy[5] +8*octorgram_result.logenergy[6]);
	SNDR = SNDR_Nu/(SNDR_De);
	//LOGF("SNDR_Nu%d\r\n", SNDR_Nu );
	//LOGF("SNDR_De%d\r\n", SNDR_De );

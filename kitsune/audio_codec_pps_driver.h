...
//			# reg[0][4][1]  = 0x20; Assume CODEC slave mode for Multi channel, For master mode uncomment the reg writes below; ASI1 Audio Interface = DSP mode
// TODO changed to I2S
    {  1,0},
//			# reg[0][4][4] = 0x40;
    {  4,(1 << 6)},

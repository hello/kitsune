...
static ConstSequentialNetwork_t initialize_network(void) {
  ...
  _layers[0] = tinytensor_create_lstm_layer(&lstm_voice_01);
  _layers[1] = tinytensor_create_fullyconnected_layer(&timedistributedvoice_01);
  return net;

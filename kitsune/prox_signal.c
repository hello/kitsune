...
#define DIFF_SIGNAL_THRESHOLD_FOR_INTERRUPTION (10)
...
static const int32_t k_change_log_likelihood = TOFIX(-0.1f,QFIXEDPOINT);
...
static const int32_t k_min_log_prob = TOFIX(-0.05f,QFIXEDPOINT);

...
/* Generated by nanopb-0.3.1 at Fri Jul 10 07:25:36 2015. */
 ...
 * field descriptors.
 */
PB_STATIC_ASSERT((pb_membersize(SyncResponse, alarm) < 65536 && pb_membersize(SyncResponse, white_noise) < 65536 && pb_membersize(SyncResponse, files) < 65536 && pb_membersize(SyncResponse, audio_control) < 65536 && pb_membersize(SyncResponse, pill_settings) < 65536 && pb_membersize(BatchedPillSettings, pill_settings[0]) < 65536), YOU_MUST_DEFINE_PB_FIELD_32BIT_FOR_MESSAGES_SyncResponse_SyncResponse_FileDownload_SyncResponse_Alarm_SyncResponse_PairingAction_SyncResponse_WhiteNoise_SyncResponse_FlashAction_SyncResponse_LEDAction_SyncResponse_PillSettings_BatchedPillSettings)
#endif
 ...
 * 8 bit descriptors.
 */
PB_STATIC_ASSERT((pb_membersize(SyncResponse, alarm) < 256 && pb_membersize(SyncResponse, white_noise) < 256 && pb_membersize(SyncResponse, files) < 256 && pb_membersize(SyncResponse, audio_control) < 256 && pb_membersize(SyncResponse, pill_settings) < 256 && pb_membersize(BatchedPillSettings, pill_settings[0]) < 256), YOU_MUST_DEFINE_PB_FIELD_16BIT_FOR_MESSAGES_SyncResponse_SyncResponse_FileDownload_SyncResponse_Alarm_SyncResponse_PairingAction_SyncResponse_WhiteNoise_SyncResponse_FlashAction_SyncResponse_LEDAction_SyncResponse_PillSettings_BatchedPillSettings)
#endif

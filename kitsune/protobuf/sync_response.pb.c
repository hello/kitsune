...
const pb_field_t SyncResponse_LEDAction_fields[4] = {
    PB_FIELD(  1, ENUM    , OPTIONAL, STATIC  , FIRST, SyncResponse_LEDAction, type, type, 0),
    PB_FIELD(  2, ENUM    , OPTIONAL, STATIC  , OTHER, SyncResponse_LEDAction, color, type, 0),
    PB_FIELD(  3, INT32   , OPTIONAL, STATIC  , OTHER, SyncResponse_LEDAction, duration, color, 0),
    PB_LAST_FIELD
};

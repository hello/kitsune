...
const pb_field_t IndividualKeywordHistogram_fields[3] = {
    ...
    PB_FIELD(  2, SINT32  , OPTIONAL, STATIC  , OTHER, IndividualKeywordHistogram, key_word_index, histogram_counts, 0),
    PB_LAST_FIELD
};
...
const pb_field_t KeywordActivation_fields[3] = {
    ...
    PB_FIELD(  2, SINT32  , OPTIONAL, STATIC  , OTHER, KeywordActivation, key_word_index, time_counter, 0),
    PB_LAST_FIELD
};

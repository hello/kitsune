...
#define batched_periodic_data_init_default       {{{NULL}, NULL}, {{NULL}, NULL}, 0, false, 0, false, "", {{NULL}, NULL}, false, ""}
...
#define batched_periodic_data_init_zero          {{{NULL}, NULL}, {{NULL}, NULL}, 0, false, 0, false, "", {{NULL}, NULL}, false, ""}
...
#define batched_periodic_data_scan_tag           8

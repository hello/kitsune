...
/* Generated by nanopb-0.3.1 at Wed Mar 09 10:24:41 2016. */
...
typedef enum _FileManifest_FileOperationError_MemoryHealthType {
    FileManifest_FileOperationError_MemoryHealthType_NO_ERROR = 0,
    FileManifest_FileOperationError_MemoryHealthType_READ_ERROR = 1,
    FileManifest_FileOperationError_MemoryHealthType_WRITE_ERROR = 2
} FileManifest_FileOperationError_MemoryHealthType;
...
typedef struct _FileManifest_File {
    ...
    bool update_file;
    pb_callback_t error_info;
} FileManifest_File;

typedef struct _FileManifest_FileOperationError {
    bool has_sd_card_health;
    FileManifest_FileOperationError_MemoryHealthType sd_card_health;
    bool has_err_code;
    int32_t err_code;
...
#define FileManifest_init_default                {{{NULL}, NULL}, false, (FileManifest_FileStatusType)0, false, 0, false, 0, false, 0, false, 0, false, FileManifest_LinkHealth_init_default, false, FileManifest_MemoryInfo_init_default}
#define FileManifest_FileDownload_init_default   {{{NULL}, NULL}, {{NULL}, NULL}, {{NULL}, NULL}, {{NULL}, NULL}, {{NULL}, NULL}}
#define FileManifest_FileOperationError_init_default {false, (FileManifest_FileOperationError_MemoryHealthType)0, false, 0}
#define FileManifest_File_init_default           {false, FileManifest_FileDownload_init_default, false, 0, false, 0, {{NULL}, NULL}}
...
#define FileManifest_init_zero                   {{{NULL}, NULL}, false, (FileManifest_FileStatusType)0, false, 0, false, 0, false, 0, false, 0, false, FileManifest_LinkHealth_init_zero, false, FileManifest_MemoryInfo_init_zero}
#define FileManifest_FileDownload_init_zero      {{{NULL}, NULL}, {{NULL}, NULL}, {{NULL}, NULL}, {{NULL}, NULL}, {{NULL}, NULL}}
#define FileManifest_FileOperationError_init_zero {false, (FileManifest_FileOperationError_MemoryHealthType)0, false, 0}
#define FileManifest_File_init_zero              {false, FileManifest_FileDownload_init_zero, false, 0, false, 0, {{NULL}, NULL}}
...
#define FileManifest_File_error_info_tag         4
#define FileManifest_FileOperationError_sd_card_health_tag 1
#define FileManifest_FileOperationError_err_code_tag 2
#define FileManifest_LinkHealth_send_errors_tag  1
#define FileManifest_LinkHealth_recv_errors_tag  2
...
#define FileManifest_device_uptime_tag           3
...
extern const pb_field_t FileManifest_fields[9];
extern const pb_field_t FileManifest_FileDownload_fields[6];
extern const pb_field_t FileManifest_FileOperationError_fields[3];
extern const pb_field_t FileManifest_File_fields[5];
extern const pb_field_t FileManifest_LinkHealth_fields[3];
extern const pb_field_t FileManifest_MemoryInfo_fields[4];

/* Maximum encoded size of messages (where known) */
#define FileManifest_FileOperationError_size     17

...
#define FileManifest_FileDownload_init_default   {{{NULL}, NULL}, {{NULL}, NULL}, {{NULL}, NULL}, false, 0, false, 0, false, 0, {{NULL}, NULL}, {{NULL}, NULL}, {{NULL}, NULL}, false, {0, {0}}}
...
#define FileManifest_FileDownload_init_zero      {{{NULL}, NULL}, {{NULL}, NULL}, {{NULL}, NULL}, false, 0, false, 0, false, 0, {{NULL}, NULL}, {{NULL}, NULL}, {{NULL}, NULL}, false, {0, {0}}}
...
#define FileManifest_FileDownload_sd_card_path_tag 9
#define FileManifest_FileDownload_sha1_tag       10
#define FileManifest_FileDownload_copy_to_serial_flash_tag 4
#define FileManifest_FileDownload_reset_network_processor_tag 5
#define FileManifest_FileDownload_reset_application_processor_tag 6
#define FileManifest_FileDownload_serial_flash_filename_tag 7
#define FileManifest_FileDownload_serial_flash_path_tag 8
...
extern const pb_field_t FileManifest_FileDownload_fields[11];

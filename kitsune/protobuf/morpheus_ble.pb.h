...
#define MorpheusCommand_PillData_init_default    {"", false, 0, false, 0, false, {0, {0}}, false, 0, 0}
#define BatchedPillData_init_default             {{{NULL}, NULL}, {{NULL}, NULL}}
...
#define MorpheusCommand_PillData_init_zero       {"", false, 0, false, 0, false, {0, {0}}, false, 0, 0}
#define BatchedPillData_init_zero                {{{NULL}, NULL}, {{NULL}, NULL}}

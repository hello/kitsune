...
/* Generated by nanopb-0.3.1 at Wed Jun 10 03:02:59 2015. */
...
typedef enum _MorpheusCommand_CommandType {
    ...
    MorpheusCommand_CommandType_MORPHEUS_COMMAND_DISABLE_WIFI_CONNECTION_UPDATES = 35
...
#define MorpheusCommand_init_default             {0, (MorpheusCommand_CommandType)0, {{NULL}, NULL}, {{NULL}, NULL}, false, (ErrorType)0, {{NULL}, NULL}, {{NULL}, NULL}, {{NULL}, NULL}, false, 0, {{NULL}, NULL}, false, (wifi_endpoint_sec_type)0, false, pill_data_init_default, false, (wifi_connection_state)0, false, 0, false, "", false, {0, {0}}, false, "", false, 0, false, 0, false, ""}
...
#define MorpheusCommand_init_zero                {0, (MorpheusCommand_CommandType)0, {{NULL}, NULL}, {{NULL}, NULL}, false, (ErrorType)0, {{NULL}, NULL}, {{NULL}, NULL}, {{NULL}, NULL}, false, 0, {{NULL}, NULL}, false, (wifi_endpoint_sec_type)0, false, pill_data_init_zero, false, (wifi_connection_state)0, false, 0, false, "", false, {0, {0}}, false, "", false, 0, false, 0, false, ""}
...
extern const pb_field_t MorpheusCommand_fields[21];

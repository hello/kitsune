...
#define Message_init_default                     {{{NULL}, NULL}, 0, false, 0, (Message_Type)0, false, PlayAudio_init_default, false, StopAudio_init_default, false, Volume_init_default}
...
#define Message_init_zero                        {{{NULL}, NULL}, 0, false, 0, (Message_Type)0, false, PlayAudio_init_zero, false, StopAudio_init_zero, false, Volume_init_zero}
...
extern const pb_field_t Message_fields[8];

...
/* Generated by nanopb-0.3.1 at Tue Aug 30 16:33:21 2016. */
...
const pb_field_t Message_fields[8] = {
 ...
 * field descriptors.
 */
PB_STATIC_ASSERT((pb_membersize(Message, play_audio) < 65536 && pb_membersize(Message, stop_audio) < 65536 && pb_membersize(Message, volume) < 65536 && pb_membersize(BatchMessage, message) < 65536), YOU_MUST_DEFINE_PB_FIELD_32BIT_FOR_MESSAGES_ReceiveMessageRequest_Message_BatchMessage_MessageStatus)
#endif
 ...
 * 8 bit descriptors.
 */
PB_STATIC_ASSERT((pb_membersize(Message, play_audio) < 256 && pb_membersize(Message, stop_audio) < 256 && pb_membersize(Message, volume) < 256 && pb_membersize(BatchMessage, message) < 256), YOU_MUST_DEFINE_PB_FIELD_16BIT_FOR_MESSAGES_ReceiveMessageRequest_Message_BatchMessage_MessageStatus)
#endif

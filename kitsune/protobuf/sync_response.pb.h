...
#define SyncResponse_init_default                {false, SyncResponse_Alarm_init_default, false, SyncResponse_WhiteNoise_init_default, false, 0, false, (SyncResponse_RoomConditions)0, {{NULL}, NULL}, false, 0, false, AudioControl_init_default, false, 0, false, SyncResponse_LEDAction_init_default, false, {0, {0}}, false, 0, 0, {SyncResponse_PillSettings_init_default, SyncResponse_PillSettings_init_default}, false, 0, false, 0}
...
#define SyncResponse_init_zero                   {false, SyncResponse_Alarm_init_zero, false, SyncResponse_WhiteNoise_init_zero, false, 0, false, (SyncResponse_RoomConditions)0, {{NULL}, NULL}, false, 0, false, AudioControl_init_zero, false, 0, false, SyncResponse_LEDAction_init_zero, false, {0, {0}}, false, 0, 0, {SyncResponse_PillSettings_init_zero, SyncResponse_PillSettings_init_zero}, false, 0, false, 0}

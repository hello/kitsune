...
/* Generated by nanopb-0.3.1 at Fri Nov 21 12:14:48 2014. */
...
typedef enum _SyncResponse_LEDAction_LEDActionType {
    SyncResponse_LEDAction_LEDActionType_FLASH = 0,
    SyncResponse_LEDAction_LEDActionType_GLOW = 1,
    SyncResponse_LEDAction_LEDActionType_PULSAR = 2,
    SyncResponse_LEDAction_LEDActionType_TRIPPY = 3
} SyncResponse_LEDAction_LEDActionType;

typedef enum _SyncResponse_LEDAction_LEDActionColor {
    SyncResponse_LEDAction_LEDActionColor_RED = 0,
    SyncResponse_LEDAction_LEDActionColor_GREEN = 1,
    SyncResponse_LEDAction_LEDActionColor_BLUE = 2,
    SyncResponse_LEDAction_LEDActionColor_LT_BLUE = 3,
    SyncResponse_LEDAction_LEDActionColor_YELLOW = 4,
    SyncResponse_LEDAction_LEDActionColor_WARN = 5,
    SyncResponse_LEDAction_LEDActionColor_ALERT = 6,
    SyncResponse_LEDAction_LEDActionColor_WHITE = 7
} SyncResponse_LEDAction_LEDActionColor;
...
typedef struct _SyncResponse_LEDAction {
    ...
    bool has_color;
    SyncResponse_LEDAction_LEDActionColor color;
    bool has_duration;
    int32_t duration;
...
#define SyncResponse_LEDAction_init_default      {false, (SyncResponse_LEDAction_LEDActionType)0, false, (SyncResponse_LEDAction_LEDActionColor)0, false, 0}
#define SyncResponse_init_zero                   {false, 0, false, 0, false, 0, false, 0, false, 0, false, SyncResponse_Alarm_init_zero, false, SyncResponse_PairingAction_init_zero, false, SyncResponse_WhiteNoise_init_zero, false, SyncResponse_FlashAction_init_zero, false, 0, false, (SyncResponse_RoomConditions)0, {{NULL}, NULL}, false, 0, false, AudioControl_init_zero, false, SyncResponse_LEDAction_init_zero}
...
#define SyncResponse_LEDAction_init_zero         {false, (SyncResponse_LEDAction_LEDActionType)0, false, (SyncResponse_LEDAction_LEDActionColor)0, false, 0}
...
#define SyncResponse_LEDAction_color_tag         2
#define SyncResponse_LEDAction_duration_tag      3
...
#define SyncResponse_led_action_tag              16

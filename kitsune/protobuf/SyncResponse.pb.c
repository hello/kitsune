...
/* Generated by nanopb-0.3.1 at Mon Nov  3 10:55:58 2014. */
...
const pb_field_t SyncResponse_fields[12] = {
...
const pb_field_t SyncResponse_Alarm_fields[6] = {
    ...
    PB_FIELD(  4, INT32   , OPTIONAL, STATIC  , OTHER, SyncResponse_Alarm, ring_offset_from_now, ringtone_id, 0),
    PB_FIELD(  5, INT32   , OPTIONAL, STATIC  , OTHER, SyncResponse_Alarm, ring_duration, ring_offset_from_now, 0),
    PB_LAST_FIELD
};

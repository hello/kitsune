...
const pb_field_t FileManifest_fields[9] = {
    ...
    PB_FIELD(  3, UINT32  , OPTIONAL, STATIC  , OTHER, FileManifest, device_uptime, file_status, 0),
    PB_FIELD(  4, UINT32  , OPTIONAL, STATIC  , OTHER, FileManifest, query_delay, device_uptime, 0),
...
const pb_field_t FileManifest_FileDownload_fields[6] = {
    ...
    PB_FIELD(  5, BYTES   , OPTIONAL, CALLBACK, OTHER, FileManifest_FileDownload, sha1, sd_card_path, 0),
    PB_LAST_FIELD
};

const pb_field_t FileManifest_FileOperationError_fields[3] = {
    PB_FIELD(  1, ENUM    , OPTIONAL, STATIC  , FIRST, FileManifest_FileOperationError, sd_card_health, sd_card_health, 0),
    PB_FIELD(  2, INT32   , OPTIONAL, STATIC  , OTHER, FileManifest_FileOperationError, err_code, sd_card_health, 0),
    PB_LAST_FIELD
};

const pb_field_t FileManifest_File_fields[5] = {
    ...
    PB_FIELD(  4, MESSAGE , REPEATED, CALLBACK, OTHER, FileManifest_File, error_info, update_file, &FileManifest_FileOperationError_fields),
    PB_LAST_FIELD
};
...
const pb_field_t FileManifest_LinkHealth_fields[3] = {
    ...
    PB_FIELD(  2, UINT32  , OPTIONAL, STATIC  , OTHER, FileManifest_LinkHealth, recv_errors, send_errors, 0),
    PB_LAST_FIELD
};
 ...
 * field descriptors.
 */
PB_STATIC_ASSERT((pb_membersize(FileManifest, file_info) < 65536 && pb_membersize(FileManifest, link_health) < 65536 && pb_membersize(FileManifest, sd_card_size) < 65536 && pb_membersize(FileManifest_File, download_info) < 65536 && pb_membersize(FileManifest_File, error_info) < 65536), YOU_MUST_DEFINE_PB_FIELD_32BIT_FOR_MESSAGES_FileManifest_FileManifest_FileDownload_FileManifest_FileOperationError_FileManifest_File_FileManifest_LinkHealth_FileManifest_MemoryInfo)
#endif
 ...
 * 8 bit descriptors.
 */
PB_STATIC_ASSERT((pb_membersize(FileManifest, file_info) < 256 && pb_membersize(FileManifest, link_health) < 256 && pb_membersize(FileManifest, sd_card_size) < 256 && pb_membersize(FileManifest_File, download_info) < 256 && pb_membersize(FileManifest_File, error_info) < 256), YOU_MUST_DEFINE_PB_FIELD_16BIT_FOR_MESSAGES_FileManifest_FileManifest_FileDownload_FileManifest_FileOperationError_FileManifest_File_FileManifest_LinkHealth_FileManifest_MemoryInfo)
#endif

...
/* Generated by nanopb-0.3.1 at Wed Mar 09 12:07:31 2016. */
...
const pb_field_t FileManifest_fields[11] = {
    ...
    PB_FIELD(  9, MESSAGE , REPEATED, CALLBACK, OTHER, FileManifest, error_info, sd_card_size, &FileManifest_FileOperationError_fields),
 ...
 * field descriptors.
 */
PB_STATIC_ASSERT((pb_membersize(FileManifest, file_info) < 65536 && pb_membersize(FileManifest, link_health) < 65536 && pb_membersize(FileManifest, sd_card_size) < 65536 && pb_membersize(FileManifest, error_info) < 65536 && pb_membersize(FileManifest_File, download_info) < 65536), YOU_MUST_DEFINE_PB_FIELD_32BIT_FOR_MESSAGES_FileManifest_FileManifest_FileDownload_FileManifest_FileOperationError_FileManifest_File_FileManifest_LinkHealth_FileManifest_MemoryInfo)
#endif
 ...
 * 8 bit descriptors.
 */
PB_STATIC_ASSERT((pb_membersize(FileManifest, file_info) < 256 && pb_membersize(FileManifest, link_health) < 256 && pb_membersize(FileManifest, sd_card_size) < 256 && pb_membersize(FileManifest, error_info) < 256 && pb_membersize(FileManifest_File, download_info) < 256), YOU_MUST_DEFINE_PB_FIELD_16BIT_FOR_MESSAGES_FileManifest_FileManifest_FileDownload_FileManifest_FileOperationError_FileManifest_File_FileManifest_LinkHealth_FileManifest_MemoryInfo)
#endif

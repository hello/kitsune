...
/* Generated by nanopb-0.3.1 at Thu Mar 10 11:36:20 2016. */
...
const pb_field_t FileManifest_FileDownload_fields[11] = {
    ...
    PB_FIELD(  4, BOOL    , OPTIONAL, STATIC  , OTHER, FileManifest_FileDownload, copy_to_serial_flash, sd_card_filename, 0),
    PB_FIELD(  5, BOOL    , OPTIONAL, STATIC  , OTHER, FileManifest_FileDownload, reset_network_processor, copy_to_serial_flash, 0),
    PB_FIELD(  6, BOOL    , OPTIONAL, STATIC  , OTHER, FileManifest_FileDownload, reset_application_processor, reset_network_processor, 0),
    PB_FIELD(  7, STRING  , OPTIONAL, CALLBACK, OTHER, FileManifest_FileDownload, serial_flash_filename, reset_application_processor, 0),
    PB_FIELD(  8, STRING  , OPTIONAL, CALLBACK, OTHER, FileManifest_FileDownload, serial_flash_path, serial_flash_filename, 0),
    PB_FIELD(  9, STRING  , OPTIONAL, CALLBACK, OTHER, FileManifest_FileDownload, sd_card_path, serial_flash_path, 0),
    PB_FIELD( 10, BYTES   , OPTIONAL, STATIC  , OTHER, FileManifest_FileDownload, sha1, sd_card_path, 0),
    PB_LAST_FIELD
};

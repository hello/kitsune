...
/* Generated by nanopb-0.3.1 at Fri May 20 15:52:53 2016. */
...
const pb_field_t periodic_data_fields[22] = {
    ...
    PB_FIELD( 25, INT32   , OPTIONAL, STATIC  , OTHER, periodic_data, infrared, co2, 0),
    PB_FIELD( 26, MESSAGE , OPTIONAL, STATIC  , OTHER, periodic_data, rgb, infrared, &periodic_data_rgb_data_fields),
    PB_LAST_FIELD
};

const pb_field_t periodic_data_rgb_data_fields[4] = {
    PB_FIELD(  1, INT32   , REQUIRED, STATIC  , FIRST, periodic_data_rgb_data, r, r, 0),
    PB_FIELD(  2, INT32   , REQUIRED, STATIC  , OTHER, periodic_data_rgb_data, g, r, 0),
    PB_FIELD(  3, INT32   , REQUIRED, STATIC  , OTHER, periodic_data_rgb_data, b, g, 0),
    PB_LAST_FIELD
};
 ...
 * field descriptors.
 */
PB_STATIC_ASSERT((pb_membersize(periodic_data, rgb) < 65536 && pb_membersize(batched_periodic_data, data) < 65536 && pb_membersize(batched_periodic_data, scan) < 65536), YOU_MUST_DEFINE_PB_FIELD_32BIT_FOR_MESSAGES_periodic_data_periodic_data_rgb_data_batched_periodic_data_batched_periodic_data_wifi_access_point)
#endif
 ...
 * 8 bit descriptors.
 */
PB_STATIC_ASSERT((pb_membersize(periodic_data, rgb) < 256 && pb_membersize(batched_periodic_data, data) < 256 && pb_membersize(batched_periodic_data, scan) < 256), YOU_MUST_DEFINE_PB_FIELD_16BIT_FOR_MESSAGES_periodic_data_periodic_data_rgb_data_batched_periodic_data_batched_periodic_data_wifi_access_point)
#endif

...
const pb_field_t batched_periodic_data_fields[7] = {
    ...
    PB_FIELD(  5, BOOL    , OPTIONAL, STATIC  , OTHER, batched_periodic_data, need_key, uptime_in_second, 0),
    PB_FIELD(  6, STRING  , OPTIONAL, CALLBACK, OTHER, batched_periodic_data, serial, need_key, 0),
    PB_LAST_FIELD
};
 ...
 * field descriptors.
 */
PB_STATIC_ASSERT((pb_membersize(batched_periodic_data, data) < 65536), YOU_MUST_DEFINE_PB_FIELD_32BIT_FOR_MESSAGES_periodic_data_batched_periodic_data)
#endif
 ...
 * 8 bit descriptors.
 */
PB_STATIC_ASSERT((pb_membersize(batched_periodic_data, data) < 256), YOU_MUST_DEFINE_PB_FIELD_16BIT_FOR_MESSAGES_periodic_data_batched_periodic_data)
#endif

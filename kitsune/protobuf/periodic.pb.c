...
/* Generated by nanopb-0.3.1 at Thu May 14 01:31:42 2015. */
...
const pb_field_t batched_periodic_data_fields[7] = {
    ...
    PB_FIELD(  5, STRING  , OPTIONAL, STATIC  , OTHER, batched_periodic_data, connected_ssid, uptime_in_second, 0),
    PB_FIELD(  6, MESSAGE , REPEATED, CALLBACK, OTHER, batched_periodic_data, scan, connected_ssid, &batched_periodic_data_wifi_access_point_fields),
    PB_LAST_FIELD
};
 ...
 * field descriptors.
 */
PB_STATIC_ASSERT((pb_membersize(batched_periodic_data, data) < 65536 && pb_membersize(batched_periodic_data, scan) < 65536), YOU_MUST_DEFINE_PB_FIELD_32BIT_FOR_MESSAGES_periodic_data_batched_periodic_data_batched_periodic_data_wifi_access_point)
#endif
 ...
 * 8 bit descriptors.
 */
PB_STATIC_ASSERT((pb_membersize(batched_periodic_data, data) < 256 && pb_membersize(batched_periodic_data, scan) < 256), YOU_MUST_DEFINE_PB_FIELD_16BIT_FOR_MESSAGES_periodic_data_batched_periodic_data_batched_periodic_data_wifi_access_point)
#endif

...
/* Generated by nanopb-0.3.1 at Thu Jul 16 13:12:13 2015. */
...
const pb_field_t batched_periodic_data_fields[8] = {
    ...
    PB_FIELD(  8, MESSAGE , REPEATED, CALLBACK, OTHER, batched_periodic_data, scan, connected_ssid, &batched_periodic_data_wifi_access_point_fields),
    PB_FIELD(  9, STRING  , OPTIONAL, STATIC  , OTHER, batched_periodic_data, ring_time_ack, scan, 0),
    PB_LAST_FIELD
};

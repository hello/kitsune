...
const pb_field_t periodic_data_fields[24] = {
    ...
    PB_FIELD( 28, MESSAGE , OPTIONAL, STATIC  , OTHER, periodic_data, tvoc_ver, keyword_stats, &periodic_data_tvoc_version_fields),
    PB_LAST_FIELD
};
...
const pb_field_t periodic_data_tvoc_version_fields[4] = {
    PB_FIELD(  1, UINT32  , OPTIONAL, STATIC  , FIRST, periodic_data_tvoc_version, tvoc_app_fw_version, tvoc_app_fw_version, 0),
    PB_FIELD(  2, UINT32  , OPTIONAL, STATIC  , OTHER, periodic_data_tvoc_version, tvoc_boot_fw_version, tvoc_app_fw_version, 0),
    PB_FIELD(  3, UINT32  , OPTIONAL, STATIC  , OTHER, periodic_data_tvoc_version, tvoc_hw_version, tvoc_boot_fw_version, 0),
    PB_LAST_FIELD
};

...
#ifndef PB_MATRIX_PB_H_INCLUDED
#define PB_MATRIX_PB_H_INCLUDED
#include <pb.h>
...
#define MatrixClientMessage_init_default         {{{NULL}, NULL}, false, 0, false, Matrix_init_default, {{NULL}, NULL}, {{NULL}, NULL}}
#define Matrix_init_default                      {{{NULL}, NULL}, 0, 0, (Matrix_DataType)0, {{NULL}, NULL}, {{NULL}, NULL}, 0, 0, {{NULL}, NULL}, {{NULL}, NULL}}
#define MatrixClientMessage_init_zero            {{{NULL}, NULL}, false, 0, false, Matrix_init_zero, {{NULL}, NULL}, {{NULL}, NULL}}
...
#define MatrixClientMessage_device_id_tag        5

/* Struct field encoding specification for nanopb */
extern const pb_field_t MatrixClientMessage_fields[6];
